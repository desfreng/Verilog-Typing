...
(**md # Equivalence between specification-based and type-system-based synthesis

   This module establishes the correspondence between the specification and
   our proposed type-system. *)

Module Equiv.
  (**md ## Main results *)

  (**md `synth_determine`: Every expression synthesizes its self-determined size. *)
  ...
  (**md `synth_must_be_determine`: Helping lemma, corollary of the previous
  ...
  (**md `synth_check_determine_order`: Helping lemma, corollary of
  ...
  (**md `synth_and_order`: Helping lemma, corollary of
     `synth_determine` and the ordering of synthesize and check. *)
  ...
  (**md `_gen_rel` and `_ts_gen`: Local automation tactics used to automatically
  ...
  (**md `spec_implies_ts`: Proves that the specification implies our type-system.
  ...
  (**md `ts_implies_spec`: Proves the converse direction:
  ...
  (**md `ts_equiv_spec`: Main equivalence theorem stating that the specification
     and the type-system are logically equivalent: each can be derived from the other. *)
